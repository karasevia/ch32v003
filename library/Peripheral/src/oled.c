...
unsigned char c, *s, ucTemp[40];
    ...
    {
       i = 0;
       while (x < OLED_WIDTH && szMsg[i] != 0 && y < OLED_HEIGHT)
       {
    ...
    {
      i = 0;
      while (x < OLED_WIDTH && y < OLED_HEIGHT && szMsg[i] != 0)
      {
//          printf("while i %d\r\n", i);
